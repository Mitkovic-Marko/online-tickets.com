...
<nav class="navbar navbar-expand-lg navbar-light" style="background: rgba(174, 220, 239, 0.6); backdrop-filter: blur(5px);">
  ...
  <div class="container-fluid py-5 text-center"> 
    ...
    <h1 class="  display-10 fw-bold" style="color:black; text-align:center;">PREGLED SVIH KORISNIKA </h1>  <br> <br> 
    <?php
...
if (isset($_SESSION['id_korisnika'])) {
    ...
    // Napravite SQL upit za dohvatanje svih korisnika
    $sql = "SELECT ime, prezime, email, telefon, adresa FROM korisnik";
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        // Prikazivanje podataka o korisnicima u tabeli
