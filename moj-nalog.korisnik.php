<?php  
session_start();
// Proverite da li postoji obaveštenje u sesiji
...
<nav class="navbar navbar-expand-lg navbar-light" style="background: rgba(174, 220, 239, 0.6); backdrop-filter: blur(5px);">
  ...
  <div class="container py-5">
      <div class="p-5 mb-4 rounded-3" style="background: rgba(174, 220, 239, 0.6); backdrop-filter: blur(1px);">
        ...
        <h1 class=" display-10 fw-bold" style="color:black">Dobrodošli na Vaš nalog</h1>  <br>
    ...
    <div class="col-md-6">
    <a href="adresa.php">
        <button type="button" class="btn btn-dark btn-lg">Promenite adresu</button>
    </a>
    </div>
     <div class="col-md-6">
     <a href="promena-sifre.php">
     <button type="button" class="btn btn-dark btn-lg" >Promenite šifru</button>
      </a>
    </div>
    <?php
    if (isset($_SESSION['obavestenje'])) {
    echo '<div class="alert alert-success text-center"  style="font-size:20px;">' . $_SESSION['obavestenje'] . '</div>';
...
if (isset($_SESSION['obavestenje1'])) {
    echo '<div class="alert alert-success" style="font-size:20px;" >' . $_SESSION['obavestenje1'] . '</div>';
    // Očistite obaveštenje iz sesije kako se ne bi prikazivalo ponovo nakon osvežavanja stranice
